        ...
        weatherRequest.onreadystatechange = function() {
            if (weatherRequest.readyState === XMLHttpRequest.DONE) {
                ...
                if (weatherRequest.status === 200) {
                    ...
                    var outputString = "<div style=\"display:flex;align-items:center;justify-content:center\"><img src=\"" + weatherIcon + "\"> " + weather.current.temp + " °C "
                            + weather.current.weather[0].description + "</div>"
